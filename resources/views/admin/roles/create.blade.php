                                ...
                                <div class="col-md-6">
                                    @foreach($permissions as $permission)
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="formCheck1" name="permissions[]" value="{{$permission['name']}}">
                                            <label class="form-check-label" for="formCheck1"> {{$permission['name_i18n']}}
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
