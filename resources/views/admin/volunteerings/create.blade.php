                ...
                <div class="col-xl-12 mx-auto" style="margin-top: 2.5%;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.volunteering.store') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="url" class="form-control"
                                                ...
                                                value="{{ old('link') }}" id="validationTooltip07">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control"
                                                   ...
                                                   value="{{ old('hours_worked') }}" id="validationTooltip11" step="0.001" >
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <img src=" {{ asset('category.jpg') }} " alt="{{ __('app.image') }}"
