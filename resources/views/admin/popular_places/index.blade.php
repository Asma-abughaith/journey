...
@section('title', __('app.dashboard-popularPlaces'))
@section('popularPlaces-active', 'active')
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <!-- start page title -->
                @include('layouts.admin.title', ['title' => __('app.popularPlaces')])
                <!-- end page title -->
                                    ...
                                    <tbody>
                                        @foreach ($popularPlaces as $key => $popularPlace)
                                            <tr>
                                                ...
                                                <td class="text-center col-2">{{ $popularPlace['place'] }}</td>
                                                <td class="text-center col-2">{{ $popularPlace['price'] }}</td>
                                                <td class="text-center col-2">
{{--                                                    @if(AdminPermission('edit category'))--}}
                                                    <a class="btn btn-outline-warning btn-sm edit" title="Edit"
                                                        href="{{ route('admin.popularPlaces.edit', $popularPlace['id']) }}">
                                                        <i class="fas fa-pencil-alt" title="Edit"></i>
                                                    </a>
{{--                                                    @endif--}}
{{--                                                    @if(AdminPermission('delete category'))--}}
                                                    <form method="post"
                                                        action="{{ route('admin.popularPlaces.destroy', $popularPlace['id']) }}"
