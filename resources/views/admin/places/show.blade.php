        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row justify-content-center" style="margin-top: 2.5%;">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body" style="background-image: url('{{ $place['main_image'] }}'); background-size: cover; background-position: center;height: 250px">
                            ...
                            <hr style="background-color: black;">
                            <p class="card-text "><strong>Google Map URL:</strong> <a href="{{ $place['google_map_url'] }}" class="text-white">{{ $place['google_map_url'] }}</a></p>
                            <hr style="background-color: black;">
                            ...
                            <hr style="background-color: black;">
                            <p class="card-text "><strong>Website:</strong> <a href="{{ $place['website'] }}" class="text-white">{{ $place['website'] }}</a></p>
                            <hr style="background-color: black;">
                            <p class="card-text "><strong>Rating:</strong> {{ $place['rating'] }}</p>
                            <hr style="background-color: black;">
                            <p class="card-text "><strong>Total User Rating:</strong> {{ $place['total_user_rating'] }}</p>
                            <hr style="background-color: black;">
