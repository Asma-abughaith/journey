                ...
                <div class="col-xl-12 mx-auto" style="margin-top: 2.5%;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.organizers.update', $organizer['id']) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('app.organizer-en') }}" id="name_en" name="name_en"
                                                value="{{ old('name_en', $organizer['name_en']) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('app.organizer-ar') }}" id="name_ar" name="name_ar"
                                                value="{{ old('name_ar', $organizer['name_ar']) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <img src="{{ $organizer['image'] != null ? asset($organizer['image']) : asset('category.jpg') }}"
                                                alt="{{ $organizer['image'] != null ? $organizer['name'] : 'avatar' }}"
