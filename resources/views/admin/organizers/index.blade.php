...
@section('title', __('app.dashboard-organizers'))
                                        ...
                                        @foreach ($organizers as $key => $organizer)
                                            <tr>
                                                ...
                                                <td class="text-center col-2"><img
                                                        src="{{ $organizer['image'] != null ? asset($organizer['image']) : asset('category.jpg') }}"
...
{{--                                                    @if(AdminPermission('delete organizer'))--}}
                                                    <form method="post"
                                                        action="{{ route('admin.organizers.destroy', $organizer['id']) }}"
