                            ...
                            <form method="post" action="{{ route('admin.events.update', $event['id']) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{{ old('name_en',$event['name_en']) }}" id="validationTooltip01" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{{ old('name_ar',$event['name_ar']) }}" id="validationTooltip02" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <textarea required name="description_en" class="form-control" rows="3" id="validationTooltip03"
                                                          placeholder="{{ __('app.description-enter-en') }}">{{ old('description_en',$event['description_en']) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <textarea required name="description_ar" class="form-control" rows="3" id="validationTooltip04"
                                                          placeholder="{{ __('app.description-enter-ar') }}">{{ old('description_ar',$event['description_ar']) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" class="form-control"
                                                   ...
                                                   value="{{ old('address_en',$event['address_en']) }}" id="validationTooltip05">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" class="form-control"
                                                   ...
                                                   value="{{ old('address_ar',$event['address_ar']) }}" id="validationTooltip06">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="datetime-local" class="form-control"
                                                   ...
                                                   value="{{ old('start_datetime',$event['start_datetime']) }}" id="validationTooltip05">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="datetime-local" class="form-control"
                                                   ...
                                                   value="{{ old('end_datetime',$event['end_datetime']) }}" id="validationTooltip06">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="url" class="form-control"
                                                   ...
                                                   value="{{ old('link',$event['link']) }}" id="validationTooltip07">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                   for="validationTooltip11">{{ __('app.price') }}</label>
                                            <input type="number" class="form-control"
                                                   placeholder="{{ __('app.price-enter') }}" name="price"
                                                   value="{{ old('price',$event['price']) }}" id="validationTooltip11" step="0.001" >
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="region_id" id="validationTooltip16">
                                                ...
                                                @foreach ($regions as $region)
                                                    <option value="{{ $region['id'] }}"  @if ($region['name'] == $event['region']) selected @endif>{{ $region['name'] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status" id="validationTooltip17">
                                                <option value="1"  @if ( $event['status'] =="Active") selected @endif>{{ __('app.active') }}</option>
                                                <option value="0"  @if ($event['status'] =="Inactive") selected @endif>{{ __('app.inactive') }}</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-control select2-multiple" name="organizers_id[]"
                                                ...
                                                @foreach ($organizers as $organizer)
                                                    <option value="{{ $organizer['id'] }}" @if (in_array($organizer['id'], array_column($event['organizers'], 'id'))) selected @endif>{{ $organizer['name'] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <img src="{{ $event['image'] }}" alt="{{ __('app.image') }}"
