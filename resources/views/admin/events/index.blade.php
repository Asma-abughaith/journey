    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <!-- start page title -->
                @include('layouts.admin.title', ['title' => __('app.events')])
                <!-- end page title -->
                                    ...
                                    <tbody>
                                        @foreach ($events as $key => $event)
                                            <tr>
                                                ...
                                                <td class="text-center col-2">{{ $event['name'] }}</td>
                                                <td class="text-center col-2">{{ $event['start_datetime'] }}</td>
                                                <td class="text-center col-2">{{ $event['address'] }}</td>
                                                <td class="text-center col-2">{{ $event['status'] }}</td>
