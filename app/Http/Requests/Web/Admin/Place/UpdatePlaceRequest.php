...
class UpdatePlaceRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $id = $place->topTenPlaces()->first() ? $place->topTenPlaces()->first()->id : null;
        return [
            ...
            'rank' => [Rule::unique('top_tens', 'rank')->ignore($id), new CheckRankRule()],
            'main_image' => 'image|mimes:jpeg,png,jpg,gif,svg,webp',
            'gallery_images.*' => 'image|mimes:jpeg,png,jpg,gif,svg,webp',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'place_type.required' => __('validation.msg.place-type'),
    ...
    public function attributes()
    {
        return [
            ...
            'place_type' => __('validation.attributes.place-type'),
